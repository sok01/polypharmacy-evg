...
DB_SIDE_E = "orlov_side_effects_dataset.db"
NUMBER_SHO = 0.3
...
class ComputeObjectF:
    ...
    def get_side_effect_data(self):
        return self.side_effect_dataset
...
if __name__ == "__main__":
    ...
    with open("merged_graph_fozinopril_ramipril_Tables.json", "r", encoding="utf-8") as table_file:
        drug_table_data = json.load(table_file)

    with open("fozinopril_ramipril_Parse.json", "r", encoding="utf-8") as graph_file:
